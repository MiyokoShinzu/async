...
/* ========================================================= 
   ...
   - Collision-free message placement 
   - Large dynamic canvas 
...
/* 
   ...
   The canvas has been increased significantly. 
 
   The previous size was: 
       3000 x 2000 
 
   New size: 
       6000 x 4000 
 
   This gives large messages much more room and 
   substantially reduces crowding when many students 
   are posting. 
*/ 
...
if ($action === "create") { 
    ...
    /* ===================================================== 
       ...
       The actual collision-free position is 
       calculated by JavaScript when the post 
       is displayed. 
 
       We initially place the post in the 
       general center region. 
 
       This prevents the database position 
       from causing clipping before the browser 
       calculates the actual text dimensions. 
    ====================================================== */ 
...
<script> 
    ...
    (function() { 
        ...
        /* ===================================================== 
           ...
           We measure the REAL canvas text width 
           using the exact font and font size. 
        ====================================================== */ 
 
        function getPostBounds( 
            post, 
            x, 
            y 
        ) { 
            ...
            const fontSize = 
                Number(post.font_size); 
 
 
            const rotation = 
                Number(post.rotation) * 
                Math.PI / 
                180; 
            ...
            /* 
                Actual vertical text extent. 
                The extra padding prevents 
                ascenders/descenders from touching 
            ...
            */ 
            ...
            /* 
                Calculate the axis-aligned bounding 
                box after rotation. 
            */ 
        ...
        /* ===================================================== 
           ...
           The new message is tested against every 
           already positioned message. 
           
           We first attempt random positions. 
           
           If the wall is getting crowded, we then 
           systematically scan the canvas. 
        ====================================================== */ 
        ...
        function findFreePosition( 
            ...
            */ 
            ...
            /* 
                Random placement failed. 
 
                Use a deterministic grid scan. 
            */ 
            ...
            /* 
                The canvas is genuinely crowded. 
 
                Return the original position rather 
                than deleting or hiding the post. 
            */ 
        ...
        /* ===================================================== 
           PREPARE POST POSITIONS 
           
           IMPORTANT: 
           
           Existing database positions are retained 
           whenever possible. 
           
           However, if an existing position would 
           overlap another post, it receives a new 
           collision-free display position. 
           
           This means old messages are also repaired 
           visually without changing the database. 
        ====================================================== */ 
 
        function preparePostPositions() { 
